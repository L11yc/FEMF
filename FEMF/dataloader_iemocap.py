...
def read_data(label_path, feature_root):
    ...
    for ii, name in enumerate(names):
        ...
        #     raise ValueError(f"Expected 1 matching feature file for '{name}', but found {len(feature_dir)}: {feature_dir}")
            ...
            for facename in facenames:
                ...
                if facename.endswith('.npy'):
                    ...
                    if 'F' in facename:
                        ...
                        print(f"Warning: Unexpected file naming in {feature_path}: {facename}")
